    ...
    <Suspense
      fallback={
        <div className="min-h-screen bg-gray-50">
          ...
          <div className="container mx-auto px-4 py-12 flex items-center justify-center pt-24">
            <div className="max-w-md w-full space-y-6">
              {/* Title skeleton */}
              ...
              <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  {/* Google button */}
                  <div className="h-10 w-full bg-gray-100 rounded-md border border-gray-200 animate-pulse" />
                </div>
              </div>
