...
const offerTypes = [
  ...
  // Coming Soon - Temporarily hidden
  // {
  //   value: 'category_sale',
  //   label: 'Category Sale',
  //   icon: FiTag,
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm">Set up a promotional offer for your store</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          <h2 className="font-semibold text-gray-800 mb-4">Select Offer Type</h2>
            ...
            {formData.type === 'promo_banner' && (
              <div className="grid gap-4 p-4 bg-pink-50 rounded-lg">
                ...
                <p className="text-xs text-gray-500">
                  Upload banner image in Payload Admin after creating
                </p>
              </div>
            )}
          </div>
