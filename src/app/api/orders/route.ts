  ...
  try {
    ...
    if (user) {
      try {
        ...
        // User fetch failed, continue with partial data
      }
    }
    ...
    // Determine delivery zone: request > user profile > inferred from address > default
    ...
    // Override with explicit request value if provided
    if (
